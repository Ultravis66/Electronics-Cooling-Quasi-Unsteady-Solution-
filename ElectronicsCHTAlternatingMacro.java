...
public class ElectronicsCHTAlternatingMacro extends StarMacro {
    ...
    private static final String VAPOR_CHAMBER = "S_Vapor_Chamber";  // Steady with fluid
    ...
    private PhysicsContinuum vaporChamber;
    ...
    public void execute() {
        try {
            ...
            sim.println("ERROR in ElectronicsCHTMacro: " + e.getMessage());
            e.printStackTrace();
            throw e;
        }
    }
    ...
    private void initializeSimulation() {
        ...
        vaporChamber = getContinuumSafely(VAPOR_CHAMBER);
    ...
    private void setActiveContinua(boolean fluidActive, boolean solidsActive) {
        ...
        vaporChamber.setIsActive(fluidActive);  // Vapor chamber follows fluid
